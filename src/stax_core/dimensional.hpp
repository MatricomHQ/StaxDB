...
inline void refine_box_for_nibble(AABB& box, uint32_t key_nibble_offset, int nibble_value, uint32_t D);
...
private:
    std::string stack_to_string() const; // For debugging
    ...
    void recompute_aabb_from_stack();
};
